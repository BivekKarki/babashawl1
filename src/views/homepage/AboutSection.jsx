...
const AboutSection = () => {
  return (
    <div id="about-us" className='py-12'>
    <div className="px-4 md:px-24 py-16">
      ...
      <div className="flex flex-wrap md:flex-nowrap items-start gap-6">
        ...
        <div className="w-full md:w-1/2   rounded-md flex justify-center items-center">
          <div className="w-1/2 h-80 bg-gray-300 flex justify-center items-center">
            <img className="w-full h-full" src="https://s3-alpha-sig.figma.com/img/0f7c/f84f/0cf0749ce04dd82308d32233adca5260?Expires=1736726400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=S1oEgXlERhx9cVhU8wEmd8ho4RM~QWIcVZ3DT32oBVh7Xy21oOzNPJV6I2JCCoUNC89LYlNLrxOKWUY8E1BoNFdUKFzqGPX4WPHXcSJ0ESNkxeuVR6-Xmx~U-qX9LasoB0feByFf4h6WkR~ULlwhdfkeuzh9GoqK~CEDRhfIvVxuEa2zsIj5AdT0FeFNcG49OBUDAo3rJBhxB8bk769F3o81HLTEES5wtHvtSuJQRc7i2rAtryvav4dJjlUfxNSUaqGoVgOwBQOueL9pVjpFPte7buSiQ9HLMAfkINpI9760LnpYFjcjDUsjzCFCrv4fDC2grBPBEziUCEEvK8SZiQ__" alt="" />
          </div>
        </div>
      </div>
    </div>
