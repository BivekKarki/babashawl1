...
const Footer = () => {
    return (
        <>
        <div>
      <footer className="bg-KSecondary text-white overflow-x-hidden ">
        <div className="mx-auto w-full sm:px-16 p-4 py-6 lg:py-16">
            ...
            <div className="grid grid-cols-1 gap-6 sm:max-md:gap-12 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-10 ">
                ...
                <div className='lg:col-span-2'>
                    <h2 className="mb-6 text-lg font-semibold text-white uppercase dark:text-white">Collections</h2>
                    <div className="flex flex-col mt-8 gap-4 text-sm ">
                        <Link href="/" className="hover:text-KPrimary text-base" > Summer</Link>
                        <Link href="/services" className="hover:text-KPrimary text-base" > Spring</Link>
                ...
                <p className=" flex flex-row items-center gap-2 ">
                    ...
                    <Link
                        href="mailto:babashawl@gmail.com"
                        className="underline  hover:text-KPrimary text-base"
                    >
                        {" "}
                        babashawl@gmail.com
...
<div className='bg-KPrimary w-full flex justify-center items-center px-4 mx-auto sm:px-6 lg:px-8'>
          <p className="text-lg font-bold md:text-lg py-2 flex items-center text-KSecondary">
          2022 - 2024 © Babashawl, All rights reserved. 
          </p>
        </div>
